...
\chapter{Examples}
	...
	\begin{figure}
		...
		\subfigure[a circuit diagramm]{\label{subfig: circuit}\includegraphics{crc/build/exampleCircuit.pdf}}
		\hspace{2cm}
		\def\svgwidth{0.3\textwidth} % define desired width
		\subfigure[made via Inkscape]{\label{subfig: svg}\input{svg/build/exampleSVG.pdf_tex}}
